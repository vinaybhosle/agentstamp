...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/blog/non-human-identity-crisis`, lastModified: "2026-03-25", changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/blog/eu-ai-act-agent-compliance`, lastModified: "2026-03-25", changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/blog/zero-trust-ai-agents`, lastModified: "2026-03-25", changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/blog/dns-agent-discovery`, lastModified: "2026-03-25", changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/blog/tamper-evident-audit-trails`, lastModified: "2026-03-25", changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/blog/x402-identity-verified-commerce`, lastModified: "2026-03-25", changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/blog/verifiable-credentials-ai-agents`, lastModified: "2026-03-25", changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/blog/guardian-agents-need-identity`, lastModified: "2026-03-25", changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/blog/mcp-server-security`, lastModified: "2026-03-25", changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/blog/agent-key-rotation-revocation`, lastModified: "2026-03-25", changeFrequency: "monthly", priority: 0.7 },
