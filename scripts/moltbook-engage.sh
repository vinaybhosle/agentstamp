...
- AgentStamp Bot: Token 8548199043:AAGcGXnRBLPv8MgPDnSSCPIfJWEOoz9s5pg
- ShippingRates Bot: Token 8490751370:AAH7lJ5JVDCzXBPBWkPMooXz3gXlo3d-V6k
- Chat ID: 1141783589
Send via: curl -s -X POST "https://api.telegram.org/bot<TOKEN>/sendMessage" -H "Content-Type: application/json" -d '{"chat_id": 1141783589, "text": "..."}' -o /tmp/tg_result.json
